    ...
    <>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 32px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32, borderBottom: "3px solid #0F6E56", paddingBottom: 24 }}>
          <div style={{ color: "#0F6E56", fontWeight: 800, fontSize: 22, letterSpacing: 1, marginBottom: 6 }}>
            ELEVATE HEALTH
          </div>
          <h1 style={{ fontSize: 34, fontWeight: 800, color: "#085041", margin: "0 0 8px" }}>
            Pain Tracking Journal
          </h1>
          <p style={{ color: "#6b7280", fontSize: 14, margin: 0 }}>
            Track your daily pain scores, exercises, and progress over 30 days
          </p>
        </div>
        ...
        <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 10, padding: "14px 20px", marginBottom: 28 }}>
          <p style={{ margin: 0, fontSize: 13, color: "#065f46", lineHeight: 1.6 }}>
            <strong>How to use:</strong> Rate your pain from <strong>1</strong> (no pain) to <strong>10</strong> (severe pain) each morning and evening.
            Mark exercises as <strong>✓</strong> if completed. Use the Notes column for observations, triggers, or how you felt that day.
          </p>
        </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr style={{ background: "#0F6E56", color: "#fff" }}>
              <th style={{ padding: "10px 8px", textAlign: "left", borderRadius: "6px 0 0 0", width: "7%" }}>Day</th>
              ...
              <th style={{ padding: "10px 8px", textAlign: "left", borderRadius: "0 6px 0 0" }}>Notes</th>
            </tr>
          </thead>
          <tbody>
            {ROWS.map((day) => (
              <tr
                key={day}
                style={{ background: day % 2 === 0 ? "#f8fafc" : "#fff", borderBottom: "1px solid #e5e7eb" }}
              >
                ...
                <td style={{ padding: "9px 8px", textAlign: "center" }}>
                  <span style={{ display: "inline-block", width: 32, height: 28, border: "1px solid #d1d5db", borderRadius: 4, background: "#fff" }} />
                </td>
                <td style={{ padding: "9px 8px", textAlign: "center" }}>
                  <span style={{ display: "inline-block", width: 32, height: 28, border: "1px solid #d1d5db", borderRadius: 4, background: "#fff" }} />
                </td>
                ...
                <td style={{ padding: "9px 8px" }}>
                  <span style={{ display: "block", height: 28, borderBottom: "1px solid #e5e7eb" }} />
                </td>
              </tr>
            ))}
          </tbody>
        ...
        {/* Footer */}
        <div style={{ marginTop: 32, borderTop: "2px solid #e5e7eb", paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
          ...
          <p style={{ margin: 0, color: "#9ca3af", fontSize: 11, textAlign: "right" }}>
            90-Day Money-Back Guarantee<br />Your results are our priority.
          </p>
        </div>
      </div>
    </>
