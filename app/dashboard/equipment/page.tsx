  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        {/* Card 1 — TRX */}
        <div className="bg-white border-2 border-teal-400 rounded-2xl shadow-md p-6 flex flex-col">
          ...
          <p className="text-xs text-gray-400 italic mt-3">
            As an Amazon Associate Dr. Oliveri earns from qualifying purchases.
          </p>
        </div>
